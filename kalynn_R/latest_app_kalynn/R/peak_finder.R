...
peak_finder <- function(file_dir, selected_dataset, selected_trait = NULL) {
   ...
   # Check if peaks_cache exists, create if not
   ...
   if (is.null(peaks_cache[[cache_key]])) {
       ...
       empty_peaks <- create_empty_peaks() # Call helper function
...
# Helper function to create an empty data frame with the expected structure
