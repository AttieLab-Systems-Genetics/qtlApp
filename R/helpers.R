...
get_trait_list <- function(import_data, trait_type) {
  ...
  # Prefer a direct 'plasma_metabolite' table; otherwise derive from row index files
  if (!is.null(trait_type) && identical(trait_type, "plasma_metabolite")) {
    ...
    # Fallback: derive plasma metabolite names directly from processed row index files
